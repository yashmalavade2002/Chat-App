			...
			<div className='w-full p-6 rounded-lg shadow-md bg-gray-400 bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-0'>
				...
				<form onSubmit={handleSubmit}>
					...
					<div>
						...
						<input type='text' placeholder='johndoe' className='w-full input input-bordered h-10 mb-2' 
					...
					<div>
						<label className='label'>
							<span className='text-base label-text mb-2'>Password</span>
						</label>
						<input
							type='password'
					...
					<div>
						<label className='label'>
							<span className='text-base label-text mb-2'>Confirm Password</span>
						</label>
						<input
							type='password'
